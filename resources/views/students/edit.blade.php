...
<head>
    ...
    <title>Edit Student | EduCare Pro</title>
            ...
            <header class="bg-white dark:bg-gray-800 shadow-sm py-4 px-6">
                <div class="flex items-center justify-between">
                    <div class="flex items-center space-x-4">
                        ...
                        <div>
                            <h2 class="text-xl font-semibold text-dark dark:text-white">Edit Student</h2>
                            <p class="text-gray-500 dark:text-gray-400 text-sm">Update student details</p>
                        </div>
                    </div>
            ...
            <main class="p-6">
                <div class="grid grid-cols-12 gap-6">
                        ...
                        <div class="bg-white dark:bg-gray-800 rounded-xl p-6 section-card">
                            ...
                            @if ($errors->any())
                                <div class="mb-4 rounded-lg border border-red-200 bg-red-50 px-4 py-3 text-sm text-red-700">
                                    <i class="fas fa-exclamation-circle mr-2"></i> Please review the highlighted fields.
                                </div>
                            @endif

                            <form id="studentForm" method="POST" action="{{ route('students.update', $student->id) }}" class="space-y-6">
                                @csrf
                                @method('PUT')
                                ...
                                <div class="grid grid-cols-2 gap-6 p-4 bg-gray-50 dark:bg-gray-800/50 rounded-xl border border-gray-200 dark:border-gray-700">
                                    <div>
                                        ...
                                        <input type="text" disabled value="{{ $student->registration_number ?? 'N/A' }}" class="form-input w-full px-4 py-3 rounded-lg bg-gray-100 dark:bg-gray-700 cursor-not-allowed italic">
                                        <p class="text-xs text-gray-500 mt-1">Registration number is system-managed.</p>
                                    </div>
                                    <div>
                                        <label class="block text-sm font-medium text-gray-700 dark:text-gray-300 mb-2">Admission Date</label>
                                        <input type="date" name="admission_date" value="{{ old('admission_date', $student->admission_date) }}" class="form-input w-full px-4 py-3 rounded-lg bg-transparent">
                                    </div>
                                </div>
                                ...
                                <div class="grid grid-cols-3 gap-6">
                                    <div>
                                        ...
                                        <input type="text" name="first_name" required value="{{ old('first_name', $student->first_name) }}" class="form-input w-full px-4 py-3 rounded-lg bg-transparent">
                                    </div>
                                    <div>
                                        <label class="block text-sm font-medium text-gray-700 dark:text-gray-300 mb-2">Middle Name</label>
                                        <input type="text" name="middle_name" value="{{ old('middle_name', $student->middle_name) }}" class="form-input w-full px-4 py-3 rounded-lg bg-transparent">
                                    </div>
                                    <div>
                                        <label class="block text-sm font-medium text-gray-700 dark:text-gray-300 mb-2">Last Name *</label>
                                        <input type="text" name="last_name" required value="{{ old('last_name', $student->last_name) }}" class="form-input w-full px-4 py-3 rounded-lg bg-transparent">
                                    </div>
                                </div>
                                ...
                                <div class="grid grid-cols-2 gap-6">
                                    ...
                                    <div>
                                        ...
                                        <input type="date" name="date_of_birth" required value="{{ old('date_of_birth', $student->date_of_birth) }}" class="form-input w-full px-4 py-3 rounded-lg bg-transparent">
                                    </div>
                                </div>
                                ...
                                <div class="grid grid-cols-2 gap-6">
                                    <div>
                                        ...
                                        <input type="text" name="prem_number" placeholder="Primary School ID" value="{{ old('prem_number', $student->prem_number) }}" class="form-input w-full px-4 py-3 rounded-lg bg-transparent">
                                    </div>
                                    <div>
                                        <label class="block text-sm font-medium text-gray-700 dark:text-gray-300 mb-2">NECTA Index (Optional)</label>
                                        <input type="text" name="necta_index_number" placeholder="SXXXX/XXXX/XXXX" value="{{ old('necta_index_number', $student->necta_index_number) }}" class="form-input w-full px-4 py-3 rounded-lg bg-transparent">
                                    </div>
                                </div>
                                ...
                                <div class="grid grid-cols-2 gap-6 pt-4 border-t border-gray-100 dark:border-gray-700">
                                    <div>
                                        ...
                                        <input type="text" name="parent_name" value="{{ old('parent_name', $student->parent_name) }}" class="form-input w-full px-4 py-3 rounded-lg bg-transparent">
                                    </div>
                                    <div>
                                        <label class="block text-sm font-medium text-gray-700 dark:text-gray-300 mb-2">Parent Phone Number</label>
                                        <input type="tel" name="parent_phone" placeholder="07xxxxxxxx" value="{{ old('parent_phone', $student->parent_phone) }}" class="form-input w-full px-4 py-3 rounded-lg bg-transparent">
                                    </div>
                                </div>
                            </form>
                        </div>
                    ...
                    <aside class="col-span-4 space-y-6">
                        <div class="bg-white dark:bg-gray-800 rounded-xl p-6 section-card">
                            <h4 class="text-lg font-semibold text-dark dark:text-white mb-4">Update Status</h4>
                            <div class="flex items-center space-x-2 mb-6">
                                <span class="w-3 h-3 bg-blue-500 rounded-full animate-pulse"></span>
                                <span class="text-sm font-medium text-gray-600 dark:text-gray-300">Editing student record</span>
                            </div>
